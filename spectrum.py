...
# #-------------New Layout Code for Testing Ends-----------------
		...
		if SubFeature == "LastBidPriceSub":
			...
			if roundoption == "Start of Round":
				...
				df_combined2 = dflastsubbidratio.applymap(str).combine(dfBLKsStartRd.applymap(str), lambda x, y: combine_text(x, y, 'BA-'))
				...
				"Winning Price - Min of Bid Value; Text in brackets (xx) - Blocks Allocated"
				...
				tab1,tab2 = st.tabs(["Absolute Value", "Ratio (Actual/ReserveP)"])  #For showning the absolute and Ratio charts in two differet tabs
				tab1.plotly_chart(figauc1, use_container_width=True)
				tab2.plotly_chart(figauc2, use_container_width=True)
			...
			if roundoption == "End of Round":
				...
				df_combined2 = dflastsubbidratio.applymap(str).combine(dfBLKsSelEndRd.applymap(str), lambda x, y: combine_text(x, y, 'BS-'))
