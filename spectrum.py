...
if selected_dimension == "Auction YearWise":
	...
	Feature = st.sidebar.selectbox('Select a Feature',["Band Details", "Operator Details"])
	...
	if Feature == "Operator Details": #for the dimension "Auction Years"
		df1 = df1.reset_index()
		df2_temp1 = df1.copy()
