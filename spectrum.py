...
if selected_dimension == "AuctionYear AllBands": #This is the new dimension Added on June 2024
	...
	activity_factor_for_selected_round = dfactvity.round(2).drop_duplicates()["Activity Factor"].values #Note this will be used in the title 
	...
	title_text = f"Auction Year: {selected_year}, Dimension: {selected_dimension}, Round: {round_number}, Actvity Factor: {activity_factor_for_selected_round}"
