...
errors_dict= {700:1, 800:1, 900:1, 1800:1, 2100:1.5, 2300:1.25, 2500:1, 3500:1, 26000:10} #debug 2024 (Feb)
...
Auction_Year_Band_Features = {
	...
	"2024-Band26000": {
		"totalrounds": 7,
		"mainsheet": "2024_5G_26000",
		"mainsheetoriginal": "2024_5G_26000_Original",
		"mainoriflag": True,
		"activitysheet": "2024_4G_5G_Activity",
		"demandsheet": "2024_5G_26000_AD",
		"titlesubpart": "26000 MHz Auctions (CY-2024)",
	...
	"2024-Band3500": {
		"totalrounds": 7,
		"mainsheet": "2024_5G_3500",
		"mainsheetoriginal": "2024_5G_3500_Original",
		"mainoriflag": True,
		"activitysheet": "2024_4G_5G_Activity",
		"demandsheet": "2024_5G_3500_AD",
		"titlesubpart": "3500 MHz Auctions (CY-2024)",
		"subtitlesubpartbidactivity": "; Combined for All Bands",
		"year": 2024,
		"band": 3500,
		"xdtick": 1,
	...
	"2024-Band2500": {
		"totalrounds": 7,
		"mainsheet": "2024_4G_2500",
		"mainsheetoriginal": "2024_4G_2500_Original",
		"mainoriflag": True,
		"activitysheet": "2024_4G_5G_Activity",
		"demandsheet": "2024_4G_2500_AD",
		"titlesubpart": "2500 MHz Auctions (CY-2024)",
		"subtitlesubpartbidactivity": "; Combined for All Bands",
		"year": 2024,
		"band": 2500,
		"xdtick": 1,
	...
	"2024-Band2100": {
		"totalrounds": 7,
		"mainsheet": "2024_4G_2100",
		"mainsheetoriginal": "2024_4G_2100_Original",
		"mainoriflag": True,
		"activitysheet": "2024_4G_5G_Activity",
		"demandsheet": "2024_4G_2100_AD",
		"titlesubpart": "2100 MHz Auctions (CY-2024)",
		"subtitlesubpartbidactivity": "; Combined for All Bands",
		"year": 2024,
		"band": 2100,
		"xdtick": 1,
	...
	"2024-Band1800": {
		"totalrounds": 7,
		"mainsheet": "2024_4G_1800",
		"mainsheetoriginal": "2024_4G_1800_Original",
		"mainoriflag": True,
		"activitysheet": "2024_4G_5G_Activity",
		"demandsheet": "2024_4G_1800_AD",
		"titlesubpart": "1800 MHz Auctions (CY-2024)",
		"subtitlesubpartbidactivity": "; Combined for All Bands",
		"year": 2024,
		"band": 1800,
		"xdtick": 1,
	 ...
	 "2024-Band900": {
		"totalrounds": 7,
		"mainsheet": "2024_4G_900",
		"mainsheetoriginal": "2024_4G_900_Original",
		"mainoriflag": True,
		"activitysheet": "2024_4G_5G_Activity",
		"demandsheet": "2024_4G_900_AD",
		"titlesubpart": "900 MHz Auctions (CY-2024)",
		"subtitlesubpartbidactivity": "; Combined for All Bands",
		"year": 2024,
		"band": 900,
		"xdtick": 1,
	...
	"2024-Band800": {
		"totalrounds": 40,
		"mainsheet": "2024_4G_800",
		"mainsheetoriginal": "2024_4G_800_Original",
		"mainoriflag": True,
		"activitysheet": "2024_4G_5G_Activity",
		"demandsheet": "2024_4G_800_AD",
		"titlesubpart": "800 MHz Auctions (CY-2024)",
		"subtitlesubpartbidactivity": "; Combined for All Bands",
		"year": 2024,
		"band": 800,
		"xdtick": 1,
...
def htext_auctionmap(dff): 
	...
	for yi, yy in enumerate(dff.index):
		...
		for xi, xx in enumerate(dff.columns):
			...
			# st.write(yi,xi) #debug 6th Feb 2025
			# st.write(offeredspectrum.values[yi][xi]) #debug 6th Feb 2025
...
def htext_colormatrix_auctiondata_2010_3G_BWA_BidsCircleWise(dfbidcirclwise, dftemp, selected_lsa,start_round,end_round,dfprovallcblks_endrd):
	...
	dfbidcirclwiselastrd = dfbidcirclwise[filt_last_round].drop(columns = ["Clk_Round","PWB_Start_ClkRd","Rank_PWB_Start_ClkRd",
		"Possible_Raise_Bid_ClkRd","Bid_Decision","PWB_End_ClkRd"]).reset_index() # Removed axis =1
