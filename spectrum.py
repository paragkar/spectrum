	...
	if selected_dimension == "Auction Data":
		...
		if Feature == "2010-Band2100":
			...
			if SubFeature == "RanksCircleWise":
				...
				plottype = st.sidebar.selectbox("Select a Plot Type", ["BarSubplots","Heatmap", "HeatmapSubP"])
				...
				if plottype == "HeatmapSubP":
					...
					for bidder in bidders:
						...
						for lsa in lsas:
							...
							st.write([1, bidder, temp[temp["Rank_PWB_End_ClkRd"]==1]["Rank_PWB_End_ClkRd"].count()])

							st.write([2, bidder, temp[temp["Rank_PWB_End_ClkRd"]==2]["Rank_PWB_End_ClkRd"].count()])

							st.write([3, bidder, temp[temp["Rank_PWB_End_ClkRd"]==3]["Rank_PWB_End_ClkRd"].count()])

							st.write([4, bidder, temp[temp["Rank_PWB_End_ClkRd"]==4]["Rank_PWB_End_ClkRd"].count()])
