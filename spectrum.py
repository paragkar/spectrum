...
if selected_dimension == "Auction Data":
	...
	if SubFeature == "ProvWinningBid":
		...
		if pwbtype == "Start CLK Round":
			...
			round_number = st.sidebar.number_input("Select Auction Round Number"+"Total Rounds= "+STR(round_numbers), min_value=min(round_numbers), max_value=max(round_numbers), value=1, step=1)
