...
def plotrwototal(sumrows, ydim, xdim):
	...
	fig.update_layout(xaxis=dict(title='India Total',side='top', title_standoff=0, ticklen=0,title_font=dict(size=text_embed_in_chart_size)), yaxis=dict(title='', showticklabels=True))
...
if selected_dimension == "Auction Data":
	...
	if SubFeature == "BlocksSelected":
		...
		sumcols.columns = ["LSA", "Slots For Sale"] 


		figsumcols = summarychart(sumcols, "LSA", "Slots For Sale")
