...
if selected_dimension == "Auction Integrated": #This is the new dimension that is being tested
	...
	for i, (band, df) in enumerate(df_dict.items(), start=1):
		...
		fig.update_xaxes(row=i, col=1, fixedrange=True, showline=True, linewidth=1.2, linecolor='black', mirror=True, showgrid=True, gridcolor='white')
		fig.update_yaxes(row=i, col=1, fixedrange=True, showline=True, linewidth=1.2, linecolor='black', mirror=True, showgrid=True, gridcolor='white')
	...
	fig.update_layout(uniformtext_minsize=text_embed_in_chart_size, 
		...
		autosize=True,
		plot_bgcolor='#87CEEB',  # Background color for the plot area light greay
		paper_bgcolor='white',
