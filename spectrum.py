...
#---------------------New Code Starts----------------------
		...
		if Feature == "Subs RuralUrban":
			...
			rural = dfRU[dfRU["Type"]=="Rural"].drop(columns ="Type", axis=1).set_index(["Date","Category"]).T

			urban = dfRU[dfRU["Type"]=="Urban"].drop(columns ="Type", axis=1).set_index(["Date","Category"]).T
