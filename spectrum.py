...
if selected_dimension == "AuctionYear AllBands": #This is the new dimension Added on June 2024
	...
	df_bid_value_provwinners = selected_dimension_df_text(dftext, "Bid Value ProvWinners").round(1)
	...
	def prepare_text_values(df, result_df):
	    combined_df = df.round(1).astype(str).replace('0', '').replace('nan', '') + result_df
	    return combined_df
