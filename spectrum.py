...
#------------------New Code Ends--------------------------------
	...
	if selected_dimension == "Business Data":
		...
		if Feature == "TowerBTS Trends":
			...
			trace1 = go.Scatter(x=dftowersbts.index, y=dftowersbts["Ratio"], name="BTSs/Towers", yaxis="y1", showlegend = False, color ='red')
			trace2 = go.Scatter(x=dftowersbts.index, y=dftowersbts["BTS"], name="BTS Trends", yaxis="y2", showlegend = False, color = 'green')
			trace3 = go.Scatter(x=dftowersbts.index, y=dftowersbts["Towers"], name="Tower Trends", yaxis="y3", showlegend = False, color = 'blue')
